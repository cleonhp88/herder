...
def run(
    ...
    *,
    ...
    Args:
        ...
        runtime: Accepted for API compatibility with cli_generic.run; ACP manages its
            own transport so this value is ignored (ACP is HTTP/stdio, not a subprocess).
        perms: Accepted for API compatibility; not used directly by ACP v1.
